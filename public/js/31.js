...
/***/ "./resources/js/Helpers/UploadProfileImage.js":
/*!****************************************************!*\
  !*** ./resources/js/Helpers/UploadProfileImage.js ***!
  \****************************************************/
/*! exports provided: upload_profile_image, updateimage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "upload_profile_image", function() { return upload_profile_image; });
...
var checkfile = function checkfile(image) {
  if (!image) {
    if (src) {
      image = profile_image;
      return false;
  ...
  var isLt2M = image.size / 1024 / 1024 < 6;
...
var upload_profile_image = function upload_profile_image(e) {
  var image = e.target.files[0];
  checkfile(image);
  scale = 1.2;
};
var updateimage = function updateimage(editor) {
  if (editor) {
    // This returns a HTMLCanvasElement, it can be made into a data URL or a blob,
    // drawn on another canvas, or added to the DOM.
    var canvas = editor.current.getImage().toDataURL();
    profile_image = canvas;
    fetch(canvas).then(function (res) {
      return res.blob();
    }).then(function (blob) {// ?Convert blob to image file var imagefile = new File([blob],
...
var Assets = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.lazy(function () {
  return Promise.all(/*! import() */[__webpack_require__.e(17), __webpack_require__.e(34)]).then(__webpack_require__.bind(null, /*! @/Pages/Auth/Assets */ "./resources/js/Pages/Auth/Assets.js"));
});
...
/* harmony import */ var _Helpers_UploadProfileImage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/Helpers/UploadProfileImage.js */ "./resources/js/Helpers/UploadProfileImage.js");
// noprotect
...
function ProfileimageInfo(_ref) {
  var data = _ref.data,
      handleChange = _ref.handleChange,
      errors = _ref.errors;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, errors.profile_image && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "text-danger"
