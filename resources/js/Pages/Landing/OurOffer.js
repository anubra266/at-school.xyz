            ...
            <div className="container">
                <div className="row mb-5 justify-content-center">
                    ...
                    >
                        ...
                        <p>
                            As we are doing our utmost best to improve, we aim
                            to get you as close as possible to offering your
                            students everything you'll offer them in a Physical
                            Classroom.
                        </p>
                    </div>
                </div>
                <div className="row mb-5 align-items-center">
                    ...
                    >
                        ...
                        <p className="mb-4">
                            Upload various forms of materials, to assist your
                        ...
                        <div className="d-flex align-items-center custom-icon-wrap mb-3">
                            ...
                            <div>
                                <h3 className="m-0">
                                    Documents such as word files, Pdf's.
                                </h3>
                            </div>
                        </div>
                        ...
                        <div className="d-flex align-items-center custom-icon-wrap">
                            ...
                            <div>
                                <h3 className="m-0">
                                    Media Files, such as Videos and Pictures.
                                </h3>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row mb-5 align-items-center">
                    ...
                    >
                        ...
                        <p className="mb-4">
                            We know, one time or another, you'll have to test
                            how much your students have learnt. We've got you
                            covered.
                        </p>
                        ...
                        <div className="d-flex align-items-center custom-icon-wrap mb-3">
                            ...
                            <div>
                                <h3 className="m-0">
                                    Theoretical Tests in rich editor.
                                </h3>
                            </div>
                        </div>
                        ...
                        <div className="d-flex align-items-center custom-icon-wrap">
                            ...
                            <div>
                                <h3 className="m-0">
                                    Timed Computer Based Test at your convenient
                                    time.
                                </h3>
                            </div>
                        </div>
                ...
                <div className="row mb-5 align-items-center">
                    ...
                    >
                        ...
                        <p className="mb-4">
                            Everything you'll meet in there is self explanatory.
                            No haggling or hassling.
                        </p>
